...
func (_m *MockMixCoordClient) UpdateSegmentColumnGroups(ctx context.Context, in *datapb.UpdateSegmentColumnGroupsRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockMixCoordClient_UpdateSegmentColumnGroups_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateSegmentColumnGroups'
type MockMixCoordClient_UpdateSegmentColumnGroups_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockMixCoordClient_Expecter) UpdateSegmentColumnGroups(ctx interface{}, in interface{}, opts ...interface{}) *MockMixCoordClient_UpdateSegmentColumnGroups_Call {
	return &MockMixCoordClient_UpdateSegmentColumnGroups_Call{Call: _e.mock.On("UpdateSegmentColumnGroups",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockMixCoordClient_UpdateSegmentColumnGroups_Call) Run(run func(ctx context.Context, in *datapb.UpdateSegmentColumnGroupsRequest, opts ...grpc.CallOption)) *MockMixCoordClient_UpdateSegmentColumnGroups_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_UpdateSegmentColumnGroups_Call) Return(_a0 *commonpb.Status, _a1 error) *MockMixCoordClient_UpdateSegmentColumnGroups_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_UpdateSegmentColumnGroups_Call) RunAndReturn(run func(context.Context, *datapb.UpdateSegmentColumnGroupsRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockMixCoordClient_UpdateSegmentColumnGroups_Call {
	_c.Call.Return(run)
	return _c
}
